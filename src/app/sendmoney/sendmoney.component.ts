...
export class SendmoneyComponent implements OnInit {
 ...
 lastbalance2: number=0;
  ...
  ngOnInit(): void {
    ...
    this.aService.lastTransaction(this.user1).subscribe((data) => { console.log(data); 
  ...
  send() {
    ...
    this.aService.lastTransaction(this.receiverid).subscribe((data) => { console.log(data); 
      ...
      // this.transaction1={//spread operator   (parseInt)
      //   ...this.transaction1,
      ...
      this.aService.addTransaction(this.transaction1)
        .subscribe( error => console.log(error));
      // this.transaction1 = new Transaction();
      this.aService.addTransaction(this.transaction2)
        .subscribe( error => console.log(error));
